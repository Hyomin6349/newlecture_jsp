		...
		<main class="main">
			...
			<div class="search-form margin-top first align-right">
				...
				<form class="table-form">
					<fieldset>
						...
						<select name="f">
							<option ${(param.f eq "title")?"selected":""} selected value="title">제목</option>
							<option ${(param.f eq "writer_id")?"selected":""} value="writer_id">작성자</option>
						</select> 
			...
			<div class="notice margin-top">
				...
				<table class="table">
					...
					<tr>
						<td>${n.id}</td>
						<td class="title indent text-align-left"><a href="detail?id=${n.id}">${n.title} <span>[${n.cmtCount }]</span></a></td>
						<td>${n.writer_id}</td>
